													...
													<div class="panel-body bg-light">
														<form method="post" action="" id="form-ui">
															<div class="section-divider mb40" id="spy1">
																<span> <p class="lead"> 数据发布源单位信息 </p> </span>
															</div>
															<!-- .section-divider -->
															...
															<div class="panel sort-disable" id="p6">
																<div class="panel-heading">
																	<span class="panel-title" style="text-align:center;display:block;">数据发布单位</span>
																</div>
																<div class="panel-body">
																	<div>

																		<hr class="short alt">
																		<a  href="release_message.php" class="button btn-social facebook btn-block">
																			<span style="width:170px;">
																				<font  face="黑体" > 发布单位编号</font>
																			</span><b id="ID_Label"> Facebook </b> </a>


																			<hr class="short alt">
																			<a href="release_message.php" class="button btn-social twitter btn-block">
																				<span style="width:170px;">
																					<font  face="黑体" >发布单位秘钥</font>
																				</span> <b id="EncryptKey_Label" > Twitter</b> </a>

																				<hr class="short alt">
																				<a  href="release_message.php" class="button btn-social googleplus btn-block">
																					<span style="width:170px;">
																						<font  face="黑体" >发布单位父亲单位编号</font>
																					</span> <b id="FatherID_Label" > Google+ </b> </a>
																					
																					<hr class="short alt">
																					<a  href="release_message.php" class="button btn-social facebook btn-block">
																						<span style="width:170px;">
																							<font  face="黑体" >发布单位名称</font>
																						</span> <b id="CompanyName_Label" > Facebook </b> </a>															  
																						<hr class="short alt">
																						<a href="release_message.php" class="button btn-social twitter btn-block">
																							<span style="width:170px;">
																								<font  face="黑体" >发布单位表结构更改信息</font>
																							</span> <b id="Reference_Label" > Twitter</b> </a>															  
