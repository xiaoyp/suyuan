    ...
    <section id="content" class="table-layout animated fadeIn"> 
      ...
      <div class="tray tray-center">
        <div class="content-header">
          <h2> <b class="text-primary">系统配置</b></h2>
        </div>
		
		<!-- Validation Example -->
            <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">

              <div class="panel heading-border" data-form-skin="primary">
                ...
                <form method="post" action="/" id="admin-form">
                  ...
                  <div class="panel-body bg-light" >
                    ...
                    <!-- .section-divider -->
                      ...
                      <label class="field select">
                        <select id="language" name="language">
                          <option value="">数据库软件选择...</option>
                          <option value="MS">MySQL</option>
                          <option value="OR">Oracle</option>
                          <option value="SS">SQL Server</option>
                        </select>
                    ...
                    <div class="section row" id="spy1">
                      <div class="col-md-6">
                        <label for="firstname" class="field prepend-icon">
                          <input type="text" name="firstname" id="firstname" class="gui-input" placeholder="数据库用户名...">
					...
					<!-- start section password -->
					  <div class="section">
                      <label for="password" class="field prepend-icon">
                        <input type="password" name="password" id="password" class="gui-input" placeholder="数据库密码">
                    ...
                    <div class="section">
                      <label for="useremail" class="field prepend-icon">
                        <input type="email" name="useremail" id="useremail" class="gui-input" placeholder="流转数据库名">
