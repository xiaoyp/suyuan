...
<!--树css-->
<link real="stylesheet" type="text/css" href="tree/tree.css">
<!--树css-->
      ...
      <ul class="nav sidebar-menu">
        ...
        <li> 
            ...
            <ul class="nav sub-nav">
            	...
            	<li class="active"> <a href="release_choose_target.php"> <span class="fa fa-dot-circle-o"></span>选择发布对象</a> </li>
            	<li> <a href="release_data.php"> <span class="fa fa-dot-circle-o"></span>导出数据</a> </li>
				      <li> <a href="test1.php"> <span class="fa fa-dot-circle-o"></span>导出流传信息到本地</a> </li>
           </ul>
    ...
    <section id="content" class="table-layout animated fadeIn"> 
      ...
      <div class="tray tray-center">
        <div class="content-header">
          <h2> <b class="text-primary">流转信息概览</b></h2>
        </div>
		
		<div class="panel" id="pchart1">
            <div class="panel-heading">
				<span class="panel-icon"> <em class="fa fa-pencil"></em> </span> <span class="panel-title">流转信息树</span>		
            </div>
            <div class="panel-body bg-light dark" id="tree-chart">
            </div>
          </div>
