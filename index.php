  ...
  <aside id="sidebar_left" class="nano nano-light affix"> 
    ...
    <div class="sidebar-left-content nano-content"> 
      ...
      <header class="sidebar-header"> 
        ...
        <div class="sidebar-widget menu-widget">
          <div class="row text-center mbn">
            <div class="col-xs-4"> <a href="login.html" class="text-primary" data-toggle="tooltip" data-placement="top"
      ...
      <ul class="nav sidebar-menu">
        ...
        <li> <a class="accordion-toggle" href="#"> <span class="fa fa-diamond"></span> <span class="sidebar-title">数据发布</span> <span class="caret"></span> </a>
          <ul class="nav sub-nav">
            <li> <a href="release_setting_environment.php"> <span class="fa fa-cube"></span>系统配置</a> </li>
            <li> <a href="release_message.php"> <span class="fa fa-desktop"></span>流转信息概览</a> </li>
            <li> <a href="release_source_confirm.php"> <span class="fa fa-columns"></span>确认发布源信息</a> </li>
            <li> <a href="release_change_schema.php"> <span class="fa fa-dot-circle-o"></span>更改表结构</a> </li>
        ...
        <li> <a class="accordion-toggle" href="#"> <span class="glyphicon glyphicon-shopping-cart"></span> <span class="sidebar-title">数据溯源</span> <span class="caret"></span> </a>
          <ul class="nav sub-nav">
            <li> <a href="find_message.html"> <span class="glyphicon glyphicon-shopping-cart"></span> 流转信息概览 </a> </li>
        ...
        <li> <a class="accordion-toggle" href="#"> <span class="glyphicon glyphicon-check"></span> <span class="sidebar-title">用户信息</span> <span class="caret"></span> </a>
          <ul class="nav sub-nav">
            <li> <a href="admin_forms-elements.html"> <span class="glyphicon glyphicon-shopping-cart"></span>用户信息概览</a> </li>
            <li> <a href="admin_forms-widgets.html"> <span class="glyphicon glyphicon-calendar"></span>密码修改</a> </li>
          </ul>
        </li>
        <!-- sidebar resources --> 
    ...
    <section id="content" class="table-layout animated fadeIn"> 
      ...
      <div class="tray tray-center">
        <div class="content-header">
          <h2> <b class="text-primary">数据溯源</b> 系统简介 </h2>
          <p class="lead">系统说明及使用介绍</p>
        </div>
        <div class="row tray-bin pt20 bg-light dark mb50">
          <div class="col-md-6 admin-grid">
            <div class="panel" id="p7" data-panel-color="panel-info" data-panel-fullscreen="false" data-panel-title="false" data-panel-remove="false" data-panel-collapse="false">
              <div class="panel-heading" style="background:#18BCF5"> 
				  <span class="panel-title" style="color: aliceblue"> 数据发布 </span> 
			  </div>
              <div class="panel-body">
                <p>Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch </p>
              </div>
            </div>
            <div class="panel" id="p8" data-panel-color="panel-warning" data-panel-fullscreen="false" data-panel-title="false" data-panel-remove="false" data-panel-collapse="false">
              <div class="panel-heading" style="background:#4F09DF"> 
				  <span class="panel-title" style="color: aliceblue"> 发布使用说明 </span> 
			  </div>
              <div class="panel-body">
                <p>Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch </p>
              </div>
          ...
          <div class="col-md-6 admin-grid">
            <div class="panel" id="p9" data-panel-color="panel-primary" data-panel-fullscreen="false" data-panel-title="false" data-panel-remove="false" data-panel-collapse="false">
              <div class="panel-heading" style="background: #31F225"> 
				  <span class="panel-title" style="color: aliceblue"> 数据溯源 </span> 
				</div>
              <div class="panel-body">
                <p>Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch </p>
              </div>
            ...
            <div class="panel" id="p10" data-panel-color="panel-alert" data-panel-fullscreen="false" data-panel-title="false" data-panel-remove="false" data-panel-collapse="false">
              <div class="panel-heading" style="background: #09A022"> 
				  <span class="panel-title" style="color: aliceblue"> 溯源使用说明 </span> 
			  </div>
              <div class="panel-body">
                <p>Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch </p>
              </div>
...
<?php
    ...
    try{
        ...
        $stmt=$conn->prepare("select * from test1");//test1要改为自己的存储节点信息的表
        $stmt->execute();
